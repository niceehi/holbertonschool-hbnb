...
## 3.7 Summary of Task 3

This task shows how the system behaves in real situations.

Key idea:

* every request follows the same path
* Facade is always the middle layer
* database is only accessed through business logic
* system is predictable and structured
...
* layered architecture (Task 1)
* core business structure (Task 2)
* request flow scenarios (Task 3)
